...
OldNamecall = hookmetamethod(game, '__namecall', function(...)
    ...
    if getnamecallmethod() == 'HttpGet' then
        if table.find(LinkTable, Args[1]) then
            Args[1] = "https://raw.githubusercontent.com/adkostatt/Strategies-X_Fix_PotatoMode_For_Delta/main/MainSource.lua"
        ...
        --[[elseif Args[1] == "https://raw.githubusercontent.com/banbuskox/dfhtyxvzexrxgfdzgzfdvfdz/main/asjhxnjfdStratFunJoin" then
            Args[1] = "https://raw.githubusercontent.com/adkostatt/Strategies-X_Fix_PotatoMode_For_Delta/main/CustomJoiningElevators.lua"
...
OldHook = hookfunction(game.HttpGet, function(Self, Url, ...)
    ...
    if table.find(LinkTable, Url) then
        Url = "https://raw.githubusercontent.com/adkostatt/Strategies-X_Fix_PotatoMode_For_Delta/main/MainSource.lua"
    ...
    --[[elseif Url == "https://raw.githubusercontent.com/banbuskox/dfhtyxvzexrxgfdzgzfdvfdz/main/asjhxnjfdStratFunJoin" then
        Url = "https://raw.githubusercontent.com/adkostatt/Strategies-X_Fix_PotatoMode_For_Delta/main/CustomJoiningElevators.lua"
